...
public class RestResposneEntityExceptionHandler {

    @ExceptionHandler(value={EntityNotFoundException.class})
    protected ResponseEntity<ApiResponse> handleNotFound(RuntimeException ex, WebRequest request)
    {
    ...
    protected ResponseEntity<ApiResponse> handleRest(RuntimeException ex, WebRequest request)
    {
