package com.medimate.WorkingHoursMicroservice.interceptor;
...
public class SystemEventsInterceptor implements HandlerInterceptor {
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler,
        ...
        SystemEventResponse systemEventResponse=stub.systemEventLog(
                org.medimate.grpc.SystemEventRequest.newBuilder()
                        .setTimestamp(LocalDateTime.now().toString())
                        .setMicroserviceName("working-hours-microservice")
                        .setUser("admin")
